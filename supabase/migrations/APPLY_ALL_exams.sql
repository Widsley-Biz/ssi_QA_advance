-- ============================================================
-- SkillCheck 模擬試験 一括適用SQL
-- ============================================================
-- Supabase ダッシュボード → SQL Editor に全文を貼り付けて Run するだけ。
-- 010(テーブル・RLS・採点関数) と 011(設問56問) をまとめてあります。
-- 既存のテーブル・関数には一切触れないので、既存機能への影響はありません。
-- 何度実行しても同じ結果になります(011はDELETE+ON CONFLICTで冪等)。
-- ============================================================
