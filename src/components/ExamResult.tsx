...
const styles: Record<string, React.CSSProperties> = {
  ...
  qBody: { marginTop: 12, fontSize: 14.5, lineHeight: 1.75, color: '#1a1a1a', overflowX: 'auto' },
  ...
  choiceText: { whiteSpace: 'pre-wrap', flex: 1 },
  ...
  explanation: { marginTop: 10, fontSize: 13.5, lineHeight: 1.8, color: '#333', background: '#F7FAFC', padding: '12px 14px', borderRadius: 8 },
